...
<div class="container section">
  <div style="max-width:70ch;">
    ...
    <h2 class="section-title" style="font-size:1.3rem;">פעילות תיווך כדין</h2>
    <p>פעילות התיווך של <?= e($settings['agency_name']) ?> מתבצעת על ידי מתווכים בעלי רישיון בהתאם
    לחוק המתווכים במקרקעין, התשנ״ו-1996. מספרי רישיון המתווכים זמינים לבקשה בפנייה ישירה אלינו.
    גביית דמי תיווך כפופה לחתימה על הזמנה בכתב לשירותי תיווך, כנדרש בחוק.</p>
