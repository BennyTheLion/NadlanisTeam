...
<div class="container section">
  <div style="max-width:70ch;">
    ...
    <h2 class="section-title" style="font-size:1.3rem;" id="section-11">הודעה לפי סעיף 11 לחוק הגנת הפרטיות</h2>
    <p>בהתאם לחוק הגנת הפרטיות, התשמ״א-1981: מסירת הפרטים בטפסי יצירת הקשר באתר (שם, טלפון, אימייל
    והודעה) נעשית מרצונכם החופשי ואינה חובה שבדין — אין חוק המחייב אתכם למסור אותם. הפרטים ישמשו
    למטרה אחת בלבד: יצירת קשר עמכם בעניין הפנייה שהגשתם (לדוגמה, מידע על נכס, סוכן או שירות ספציפי
    שביקשתם). הפרטים עשויים להיות מועברים לסוכן/ה או לשותף העסקי הרלוונטי באתר לצורך הטיפול בפנייתכם
    בלבד, ולא לכל גורם אחר. אי-מסירת הפרטים משמעה שלא נוכל לחזור אליכם בנוגע לפנייה.</p>
